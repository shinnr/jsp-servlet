...
$(function(){
	...
	$('#btn3').click(function() {
		if(eval('${!empty LOGIN_MEMBERINFO}')){
			// /ddit/13/main.jsp?contentPage=/13/freeboard/freboardReplyForm.jsp?rnum=${param.rnum}&bo_title=${freeboard.bo_title}
			//한글처리'
	...
	$('form[name=freeboardViewF]').submit(function() {
...
<body>
<form name="freeboardViewF" class="form-horizontal" role="form" action="" method="post">

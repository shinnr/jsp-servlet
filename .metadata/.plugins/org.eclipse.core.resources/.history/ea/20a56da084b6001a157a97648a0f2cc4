...
<body>
<img src="/files/${fileName }" alt="왜 안나와" width="200px" height="150px" onclick="javascript:location.href='${pageContext.request.contextPath}/14/fileDownload.jsp?fileName=${fileName }';"/>
</body>
</html>